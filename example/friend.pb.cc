...
class GetFriendsListRequsetDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<GetFriendsListRequset> _instance;
} _GetFriendsListRequset_default_instance_;
...
static void InitDefaultsscc_info_GetFriendsListRequset_friend_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_GetFriendsListRequset_default_instance_;
    new (ptr) ::fixbug::GetFriendsListRequset();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::GetFriendsListRequset::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetFriendsListRequset_friend_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_GetFriendsListRequset_friend_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_friend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendsListRequset, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendsListRequset, userid_),
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 7, -1, sizeof(::fixbug::GetFriendsListRequset)},
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_GetFriendsListRequset_default_instance_),
...
const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "FriendsListRequset\032\036.fixbug.GetFriendsLi"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_friend_2eproto_sccs[3] = {
  &scc_info_GetFriendsListRequset_friend_2eproto.base,
...
void GetFriendsListRequset::InitAsDefaultInstance() {
}
class GetFriendsListRequset::_Internal {
 public:
};

GetFriendsListRequset::GetFriendsListRequset(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:fixbug.GetFriendsListRequset)
}
GetFriendsListRequset::GetFriendsListRequset(const GetFriendsListRequset& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  userid_ = from.userid_;
  // @@protoc_insertion_point(copy_constructor:fixbug.GetFriendsListRequset)
}

void GetFriendsListRequset::SharedCtor() {
  userid_ = 0u;
}

GetFriendsListRequset::~GetFriendsListRequset() {
  // @@protoc_insertion_point(destructor:fixbug.GetFriendsListRequset)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void GetFriendsListRequset::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
}

void GetFriendsListRequset::ArenaDtor(void* object) {
  GetFriendsListRequset* _this = reinterpret_cast< GetFriendsListRequset* >(object);
  (void)_this;
}
void GetFriendsListRequset::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void GetFriendsListRequset::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const GetFriendsListRequset& GetFriendsListRequset::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendsListRequset_friend_2eproto.base);
  return *internal_default_instance();
}


void GetFriendsListRequset::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetFriendsListRequset)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetFriendsListRequset::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendsListRequset::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetFriendsListRequset)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetFriendsListRequset)
  return target;
}

size_t GetFriendsListRequset::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendsListRequset)
  size_t total_size = 0;
...
void GetFriendsListRequset::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.GetFriendsListRequset)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendsListRequset* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendsListRequset>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.GetFriendsListRequset)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.GetFriendsListRequset)
    MergeFrom(*source);
  }
}

void GetFriendsListRequset::MergeFrom(const GetFriendsListRequset& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendsListRequset)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetFriendsListRequset::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.GetFriendsListRequset)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void GetFriendsListRequset::CopyFrom(const GetFriendsListRequset& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetFriendsListRequset)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetFriendsListRequset::IsInitialized() const {
  return true;
}

void GetFriendsListRequset::InternalSwap(GetFriendsListRequset* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  swap(userid_, other->userid_);
}

::PROTOBUF_NAMESPACE_ID::Metadata GetFriendsListRequset::GetMetadata() const {
  return GetMetadataStatic();
}
...
void FriendServiceRpc::GetFriendsList(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::fixbug::GetFriendsListRequset*,
  ...
  switch(method->index()) {
    case 0:
      GetFriendsList(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::GetFriendsListRequset*>(
                 request),
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendServiceRpc::GetRequestPrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::fixbug::GetFriendsListRequset::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFriendsListRequset* Arena::CreateMaybeMessage< ::fixbug::GetFriendsListRequset >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::GetFriendsListRequset >(arena);
}

...
namespace fixbug {
class GetFriendsListRequset;
class GetFriendsListRequsetDefaultTypeInternal;
extern GetFriendsListRequsetDefaultTypeInternal _GetFriendsListRequset_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::fixbug::GetFriendsListRequset* Arena::CreateMaybeMessage<::fixbug::GetFriendsListRequset>(Arena*);
...
class GetFriendsListRequset PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendsListRequset) */ {
 public:
  inline GetFriendsListRequset() : GetFriendsListRequset(nullptr) {};
  virtual ~GetFriendsListRequset();

  GetFriendsListRequset(const GetFriendsListRequset& from);
  GetFriendsListRequset(GetFriendsListRequset&& from) noexcept
    : GetFriendsListRequset() {
    *this = ::std::move(from);
  }

  inline GetFriendsListRequset& operator=(const GetFriendsListRequset& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendsListRequset& operator=(GetFriendsListRequset&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetFriendsListRequset& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetFriendsListRequset* internal_default_instance() {
    return reinterpret_cast<const GetFriendsListRequset*>(
               &_GetFriendsListRequset_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(GetFriendsListRequset& a, GetFriendsListRequset& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendsListRequset* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(GetFriendsListRequset* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline GetFriendsListRequset* New() const final {
    return CreateMaybeMessage<GetFriendsListRequset>(nullptr);
  }

  GetFriendsListRequset* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetFriendsListRequset>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetFriendsListRequset& from);
  void MergeFrom(const GetFriendsListRequset& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendsListRequset* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendsListRequset";
  }
  protected:
  explicit GetFriendsListRequset(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendsListRequset)
 private:
  class _Internal;
...
// uint32 userid = 1;
inline void GetFriendsListRequset::clear_userid() {
  userid_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendsListRequset::_internal_userid() const {
  return userid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendsListRequset::userid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendsListRequset.userid)
  return _internal_userid();
}
inline void GetFriendsListRequset::_internal_set_userid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  userid_ = value;
}
inline void GetFriendsListRequset::set_userid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_userid(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendsListRequset.userid)
}
